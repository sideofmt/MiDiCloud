...
<p>
é¸æããMIDIãã¡ã¤ã«ãåé¤ãã¾ããï¼
</p>
</div>
...
<button type="submit" class="btn btn-info btn-lg">ã­ã£ã³ã»ã«</button>
<button type="submit" class="btn btn-warning btn-lg">ã¯ã</button>
</div>
</div>
